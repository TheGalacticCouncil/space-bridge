    ...
    public handleEvent(message: any) {
        ...
        switch (message.event) {
            ...
            case "SET_IMPULSE_ENGINES_COOLANT":
                ...
                break;
            case "REPLACE":
                console.log("REPLACE: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            ...
            case "LAUNCH_PROBE":
                ...
                break;
            case "SELECT_WEAPON":
                console.log("SELECT_WEAPON: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "LOAD_TUBE":
                console.log("LOAD_TUBE: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "LOAD_REAR_TUBE":
                console.log("LOAD_REAR_TUBE: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "FIRE_TUBE":
                console.log("FIRE_TUBE: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "UNLOAD_TUBE":
                console.log("UNLOAD_TUBE: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            ...
            case "SET_BEAM_TARGET":
                console.log("SET_BEAM_TARGET: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "NEXT_BEAM_TARGET":
                console.log("NEXT_BEAM_TARGET: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            ...
            case "SET_SHIELD_FREQUENCY":
                console.log("SET_SHIELD_FREQUENCY: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "NEXT_SHIELD_FREQUENCY":
                console.log("NEXT_SHIELD_FREQUENCY: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "PREVIOUS_SHIELD_FREQUENCY":
                console.log("PREVIOUS_SHIELD_FREQUENCY: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "CALIBRATE_SHIELDS":
                console.log("CALIBRATE_SHIELDS: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "SHIELDS_UP":
                console.log("SHIELDS_UP: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
            case "SHIELDS_DOWN":
                console.log("SHIELDS_DOWN: ", message.event, "-----NOT_IMPLEMENTED!!-----");
                break;
